// The official and maintained NamedList class is now here in adclib.
// A copy called MNamedList remains in Modality for backwards compatibility only,
// and will not be maintained by me.
